...
type GrretManyTimesReponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *GrretManyTimesReponse) Reset() {
	*x = GrretManyTimesReponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *GrretManyTimesReponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GrretManyTimesReponse) ProtoMessage() {}

func (x *GrretManyTimesReponse) ProtoReflect() protoreflect.Message {
	mi := &file_greet_greetpb_greet_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GrretManyTimesReponse.ProtoReflect.Descriptor instead.
func (*GrretManyTimesReponse) Descriptor() ([]byte, []int) {
	return file_greet_greetpb_greet_proto_rawDescGZIP(), []int{4}
}

func (x *GrretManyTimesReponse) GetResult() string {
	if x != nil {
		return x.Result
	}
	return ""
...
var file_greet_greetpb_greet_proto_rawDesc = []byte{
	...
	0x65, 0x65, 0x74, 0x69, 0x6e, 0x67, 0x22, 0x2f, 0x0a, 0x15, 0x47, 0x72, 0x72, 0x65, 0x74, 0x4d,
	0x61, 0x6e, 0x79, 0x54, 0x69, 0x6d, 0x65, 0x73, 0x52, 0x65, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12,
	...
	0x2e, 0x67, 0x72, 0x65, 0x65, 0x74, 0x2e, 0x47, 0x72, 0x72, 0x65, 0x74, 0x4d, 0x61, 0x6e, 0x79,
	0x54, 0x69, 0x6d, 0x65, 0x73, 0x52, 0x65, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x30, 0x01,
...
var file_greet_greetpb_greet_proto_goTypes = []interface{}{
	...
	(*GrretManyTimesReponse)(nil), // 4: greet.GrretManyTimesReponse
}
var file_greet_greetpb_greet_proto_depIdxs = []int32{
	...
	4, // 5: greet.GreetService.GreetManyTimes:output_type -> greet.GrretManyTimesReponse
...
func file_greet_greetpb_greet_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_greet_greetpb_greet_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GrretManyTimesReponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
...
type GreetService_GreetManyTimesClient interface {
	Recv() (*GrretManyTimesReponse, error)
	grpc.ClientStream
}
...
func (x *greetServiceGreetManyTimesClient) Recv() (*GrretManyTimesReponse, error) {
	m := new(GrretManyTimesReponse)
...
type GreetService_GreetManyTimesServer interface {
	Send(*GrretManyTimesReponse) error
	grpc.ServerStream
}
...
func (x *greetServiceGreetManyTimesServer) Send(m *GrretManyTimesReponse) error {
